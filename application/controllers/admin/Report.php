    ...
    function user_join($user_id ='') {
        ...
        if($user_id){
            ...
            foreach ($address->result() as $row) {
                ...
                $details['add_address'][$j]['state'] = $row->state_id;
                $j++;
            }
             $flag = 1;
        ...
        if($this->input->post('add_address')){
            ...
            $res = $this->report_model->updateAddaddress($address_post,$user_id);
        ...
        $user_address = $this->report_model->getUserAddresses($user_id);

        $this->setData('user_address', $user_address);
        $this->setData('details', $details);
