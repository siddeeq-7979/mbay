...
defined('NO_LOGIN_PAGES') OR define('NO_LOGIN_PAGES', array("login", "employee-login","affiliate-login", "register", "translator", "cart", "auto_register", "lcp", "replication", "verify","client","cron_job","lang-translator","shop","webpage_reload","checkout","order_success")); //PAGES THAT DOESN'T NEED LOGGED IN SESSION
